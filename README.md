...
This repository contains a benchmark pipeline for intrusion-detection datasets with a focus on class imbalance handling.
...
The main entrypoint of the project is [project/main.py](project/main.py), and it reads settings from [project/paper_style_config.yaml](project/paper_style_config.yaml).
...
- [project/main.py](project/main.py): project entrypoint
- [project/paper_style_config.yaml](project/paper_style_config.yaml): full benchmark configuration
- [project/requirements.txt](project/requirements.txt): Python packages
- [project/src/runner.py](project/src/runner.py): full benchmark pipeline
- [project/src/data_loader.py](project/src/data_loader.py): dataset loading and label binarization
- [project/src/preprocessing.py](project/src/preprocessing.py): preprocessing pipeline

Main outputs after a run:

- `project/paper_style_outputs`
- per-dataset subfolders such as:
  - `project/paper_style_outputs/cic_unsw`
  - `project/paper_style_outputs/cic_iomt_2024`
...
This runs the benchmark exactly as defined in [project/paper_style_config.yaml](project/paper_style_config.yaml):
...
If you are using `.venv_clean` one level above `project`:
...
- `project/paper_style_outputs/<dataset_name>/benchmark_results.csv`
- `project/paper_style_outputs/<dataset_name>/top_ranked_configs.csv`
- `project/paper_style_outputs/<dataset_name>/best_model_summary.json`
- `project/paper_style_outputs/<dataset_name>/models/best_model.joblib`
- `project/paper_style_outputs/<dataset_name>/report.md`

Also check the aggregated outputs:

- `project/paper_style_outputs/all_datasets_rankings.csv`
- `project/paper_style_outputs/table_iii_before_handling_all.csv`
- `project/paper_style_outputs/table_iv_after_handling_all.csv`

## 8. How Labels Are Converted to Benign vs Attack

This project turns labels into binary classes in [project/src/data_loader.py](project/src/data_loader.py).
...
Edit [project/paper_style_config.yaml](project/paper_style_config.yaml).
...
- `project/paper_style_outputs/my_new_dataset`
